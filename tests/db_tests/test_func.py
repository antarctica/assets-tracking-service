...
class TestDbFuncUlid:
    ...
    def test_generate(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_parse(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_ulid_to_uuid(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_uuid_to_ulid(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
...
class TestDbFuncDdm:
    ...
    def test_format(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
...
class TestDbFuncLabelsValidity:
    ...
    def test_valid(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_invalid_wrapper_not_obj(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_invalid_wrapper_no_version(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_invalid_wrapper_invalid_version(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_invalid_wrapper_no_values(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_invalid_values_not_list(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_invalid_items_not_objects(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_invalid_missing_required_scheme(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_invalid_missing_pref_labels(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
    ...
    def test_invalid_multiple_pref_labels(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
...
class TestDbFuncSetUpdatedAt:
    ...
    def test_updated_at(self: Self, fx_db_client_tmp_db_mig: DatabaseClient):
        """`updated_at` column is updated on change."""
