...
class TestAssetNew:
    ...
    def test_not_one_pref_label(self: Self, fx_label_minimal: Label):
    ...
    def test_to_db_dict(self: Self, fx_asset_new: AssetNew):
    ...
    def test_eq(self: Self, fx_labels_one: Labels, fx_label_minimal: Label, fx_label_expired: Label):
        """Equality check."""
...
class TestAsset:
    ...
    def test_init(self: Self, fx_asset_id: ULID, fx_labels_one: Labels):
        """Creates an Asset."""
    ...
    def test_to_db_dict(self: Self, fx_asset: Asset):
        """
        Converts Asset to a database dict.
    ...
    def test_from_db_dict(self: Self, fx_asset: Asset, fx_label_full_plain: LabelsPlain):
    ...
    def test_pref_label(self: Self, fx_asset: Asset):
...
class TestAssetsClient:
    ...
    def test_assets_client_add(self: Self, fx_assets_client_empty: AssetsClient, fx_asset_new: AssetNew):
        """Add an Asset."""
    ...
    def test_assets_client_list_filtered_by_label_complete(
        self: Self, fx_assets_client_many: AssetsClient, fx_asset: Asset
    ):
    ...
    def test_assets_client_list_filtered_by_label_minimal(
        self: Self, fx_assets_client_many: AssetsClient, fx_label_minimal: Label, fx_asset: Asset
    ):
