...
class TestExporterGeoJson:
    ...
    def test_data(self: Self, fx_exporter_geojson: GeoJsonExporter):
        """Generates data."""
    ...
    def test_data_keys_order(self: Self, fx_exporter_geojson: GeoJsonExporter):
    ...
    @pytest.mark.cov()
    def test_data_empty(
        self: Self, fx_config: Config, fx_db_client_tmp_db_mig: DatabaseClient, fx_logger: logging.Logger
    ):
    ...
    def test_export(self: Self, fx_exporter_geojson: GeoJsonExporter):
        """Exports data."""
    ...
    def test_export_path(self: Self, fx_exporter_geojson: GeoJsonExporter):
