...
from tests.resources.lib.data_catalogue.records.item_cat_data import record as product_data
...
class TestItemTabs:
    ...
    def test_switch(self, fx_lib_exporter_static_server: Popen, page: Page):
    ...
    def test_history(self, fx_lib_exporter_static_server: Popen, page: Page):
    ...
    def test_load(self, fx_lib_exporter_static_server: Popen, page: Page):
...
class TestItemDataActions:
    ...
    def test_access_info(self, fx_lib_exporter_static_server: Popen, page: Page):
