...
class TestMacrosItem:
    ...
    def test_header(self, fx_lib_item_catalogue_min: ItemCatalogue):
        ...
        expected = fx_lib_item_catalogue_min.page_header
    ...
    def test_edition(self, fx_lib_item_catalogue_min: ItemCatalogue, value: str | None):
        ...
        fx_lib_item_catalogue_min._record.identification.edition = value
        expected = fx_lib_item_catalogue_min.summary.edition
        html = BeautifulSoup(fx_lib_item_catalogue_min.render(), parser="html.parser", features="lxml")
    ...
    def test_published(self, fx_lib_item_catalogue_min: ItemCatalogue, value: Date | None):
        """Can get item publication with expected value from item."""
        fx_lib_item_catalogue_min._record.identification.dates.publication = value
        expected = fx_lib_item_catalogue_min.summary.published
        html = BeautifulSoup(fx_lib_item_catalogue_min.render(), parser="html.parser", features="lxml")
    ...
    def test_citation(self, fx_lib_item_catalogue_min: ItemCatalogue, value: str | None):
        ...
        fx_lib_item_catalogue_min._record.identification.other_citation_details = value
        expected = fx_lib_item_catalogue_min.summary.citation
        html = BeautifulSoup(fx_lib_item_catalogue_min.render(), parser="html.parser", features="lxml")
    ...
    def test_abstract(self, fx_lib_item_catalogue_min: ItemCatalogue):
        """Can get item abstract with expected value from item."""
        html = BeautifulSoup(fx_lib_item_catalogue_min.render(), parser="html.parser", features="lxml")
        expected = fx_lib_item_catalogue_min.summary.abstract
    ...
    def test_graphics(self, fx_lib_item_catalogue_min: ItemCatalogue, value: GraphicOverviews):
        """Can get item graphics with expected values from item."""
        fx_lib_item_catalogue_min._record.identification.graphic_overviews = value
        expected = fx_lib_item_catalogue_min.graphics
        html = BeautifulSoup(fx_lib_item_catalogue_min.render(), parser="html.parser", features="lxml")
    ...
    def test_tab_nav_default(self, fx_lib_item_catalogue_min: ItemCatalogue):
        """
        ...
        """
        html = BeautifulSoup(fx_lib_item_catalogue_min.render(), parser="html.parser", features="lxml")
        expected = fx_lib_item_catalogue_min.default_tab_anchor
