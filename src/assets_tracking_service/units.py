...
class UnitsConverter:
    ...
    def kilometers_per_hour_to_meters_per_second(self: Self, speed: float) -> float:
        """Convert velocity from km/h to m/s."""
        km_h = speed * self._units.parse_units("kilometer/hour")
        return km_h.to(self._units.meter / self._units.second).magnitude

    def knots_to_meters_per_second(self: Self, speed: float) -> float:
    ...
    def feet_to_meters(self: Self, distance: float) -> float:
