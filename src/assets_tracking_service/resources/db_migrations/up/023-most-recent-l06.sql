...
-- Summary --
/*
 This migration changes the lateral joins to select the asset L06 (type) code and preference label to cope with
 multiple labels.

 Previously, all labels would have matched, leading to duplicate rows in the view.
 Now we select the single most recent, non-expired label.
